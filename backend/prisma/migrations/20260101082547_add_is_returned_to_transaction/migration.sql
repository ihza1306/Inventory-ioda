...
INSERT INTO "new_TransactionHistory" ("item_id", "notes", "qty_change", "timestamp", "trx_id", "type", "user_id") SELECT "item_id", "notes", "qty_change", "timestamp", "trx_id", "type", "user_id" FROM "TransactionHistory";
